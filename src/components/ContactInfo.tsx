...
const ContactInfo = () => {
  return (
    <div className="main-container mx-auto snap-always snap-center">
      <section
        id="contact"
        className="pt-[8vh] pb-[2vh] relative lg:min-h-[85vh] text-center flex flex-col justify-center"
      >
        <p className="font-medium xxs:text-xs sm:text-sm md:text-base my-1">
          Get in Touch
        </p>
        <h1 className="section-heading">Contact Me</h1>
        <div className="block md:flex md:justify-center w-fit border-1 border-wineberry-950 rounded-2xl p-2 px-8 mx-auto xxs:my-4 md:my-6 lg:my-8">
